# Functional Specification Document (FSD) — vFinal (Defensa)

> **Caso crítico:** FSD-UC-002 — prompt-contract en `prompts/PR-FSD-UC-002.md`  
> **Trazabilidad:** `docs/TRAZABILIDAD_COMPLETA.md` · DTI `docs/DTI.md`
...
#### Aviso-contrato (Prompt Contract) — obligatorio para implementación

| Elemento | Referencia |
|----------|------------|
| **ID** | `PR-FSD-UC-002` |
| **Archivo ejecutable** | [`prompts/PR-FSD-UC-002.md`](../../prompts/PR-FSD-UC-002.md) |
| **Registro métricas** | [`docs/PROMPT_MAPPING.md`](../PROMPT_MAPPING.md) §2 |
| **Skill agente** | `docs/SKILLS/dj-validator.md` |
| **Invariantes** | RB-01 (ENVIAR), RB-03 (inmutabilidad), RB-06 (historial atómico) |
| **Diagramas** | `docs/diagrams/seq_uc002_dj_envio.mmd`, `state_dj.mmd` |
| **POC validación** | POC-02 — concurrencia pass |
