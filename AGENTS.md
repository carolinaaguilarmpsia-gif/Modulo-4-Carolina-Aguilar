...
>
> **Versión extendida:** [`docs/AGENTS/AGENTS.md`](docs/AGENTS/AGENTS.md) (mismo contrato + ejemplos).
>
...
versión_documentación: Release 2.0.0 (Defensa DTI vFinal)
...
diagramas:
  ...
  evolución_cloud: docs/diagrams/deploy_aws_v2_target.mmd
```
